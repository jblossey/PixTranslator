...
import com.vaadin.flow.router.Route;import com.pixtranslator.views.root.RootView;


@Route(value = "photo-list", layout = RootView.class)
@PageTitle("Photo List")
@CssImport(value = "styles/views/photolist/photo-list-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class PhotoListView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public PhotoListView() {
        setId("photo-list-view");
        addClassName("photo-list-view");
        setSizeFull();
        grid.setHeight("100%");
