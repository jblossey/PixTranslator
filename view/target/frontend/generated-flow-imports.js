...
import $css_1 from 'Frontend/styles/views/photolist/photo-list-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_1}</style></custom-style>`);
import $css_2 from 'Frontend/styles/views/root/root-view.css';
addCssBlock(`<dom-module id="flow_css_mod_2" theme-for="vaadin-app-layout"><template><style>${$css_2}</style></template></dom-module>`);
